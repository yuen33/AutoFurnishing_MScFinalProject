...
//		col.gameObject.transform.position=col.gameObject.transform.position+movingDirection*0.001f;
...
//		movingDirection=Room.walls[wallID_Pi,2];//wall normal
//		col.gameObject.rigidbody.detectCollisions=false;
//		col.gameObject.transform.position=col.gameObject.transform.position+movingDirection*0.002f;
//		col.gameObject.rigidbody.detectCollisions=true;
//		
//	}
//		
